...
class ParamNode(AstNode):
    def __init__(self, var_type: TypeNode, var_name: IdentNode,
                 row: Optional[int] = None, line: Optional[int] = None, **props):
        super().__init__(row=row, line=line, **props)
...
class ParamListNode(AstNode):
    ...
    def childs(self) -> Tuple[ParamNode]:
        return self.params if self.params else tuple()
...
class FunDeclNode(StmtNode):
    def __init__(self, return_type: TypeNode, name: IdentNode, params: ParamListNode, func_body: Optional[StmtNode] = None,
                 row: Optional[int] = None, line: Optional[int] = None, **props):
        super().__init__(row=row, line=line, **props)
    ...
    @property
    def childs(self) -> Tuple[AstNode, ...]:
        return (self.return_type, self.name, self.params,) + ((self.func_body,) if self.func_body else tuple())
...
class CallNode(StmtNode):
    ...
    def childs(self) -> Tuple[IdentNode, ...]:
        if isinstance(self.func, InNode):
            return self.params + (self.func,)

...
VOID, INT, FLOAT, BOOL, MAP = BaseType.VOID, BaseType.INT, BaseType.FLOAT, BaseType.BOOL, BaseType.MAP
...
class TypeDesc:
    ...
    def __init__(self, base_type_: Optional[BaseType] = None, map_types: Optional[Tuple['TypeDesc']] = (),
    ...
    def __eq__(self, other: 'TypeDesc'):
        ...
        if not self.func:
            ...
            if self.return_type != other.return_type:
                return False
            if len(self.map_types) != len(other.map_types):
                return False
            for i in range(len(self.map_types)):
                if self.map_types[i] != other.map_types[i]:
                    return False
